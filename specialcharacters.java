...
public class specialcharacters {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            try {
                FileUtils.copyFile(screenshot, new File("special characters sucessfully.png"));
                System.out.println(" Screenshot saved as 'special characters sucessfully.png'");
            } catch (IOException e) {
